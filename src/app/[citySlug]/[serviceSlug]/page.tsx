...
function getUniqueIntro(cityName: string, serviceName: string, region: string): string {
  const intros = [
    ...
    `Für Ihr ${serviceName}-Projekt in ${cityName} sind Sie bei RD Frankenbau in besten Händen. Wir verbinden handwerkliche Präzision mit modernster Technik und liefern Ergebnisse, die überzeugen.`
  ];
              ...
              <div className="space-y-6">
                ...
                <div className="bg-card rounded-2xl p-6 lg:p-8 border border-border sticky top-28">
                  ...
                  <div className="space-y-4">
                    ...
                    <a href="tel:+491742629258" className="block">
