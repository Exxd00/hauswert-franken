...
class Sheet {
 constructor(name, rows=[],id=1){this.name=name;this.rows=rows;this.id=id;this.cols=26;}
 ...
 getLastRow(){return this.rows.length}getMaxColumns(){return this.cols}insertColumnsAfter(_,n){this.cols+=n}setFrozenRows(){}setRowHeight(){}setColumnWidths(){}setColumnWidth(){}
}
